...
//
//			AllTabsPage.getinstance().Click_Pdt();
//			Assert.assertTrue(Productpage.getinstance().verifytitle(),"Product Title mismatched");
//			Productpage.getinstance().selectproduct(1);
//			
